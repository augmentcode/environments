...
UBUNTU_IMAGE_TAG_2004 := ubuntu:20.04
...
export GPU_GPT_NEOX_DEEPSPEED_ENVIRONMENT_NAME_270 := $(CUDA_128_PREFIX)$(PY_39_TAG)pytorch-2.7.0-gpt-neox-deepspeed$(GPU_SUFFIX)
